...
If the response includes a `stream_command`, follow it using Pi's detached `tmux` workflow so it does not block the turn, and relay notable progress as it arrives.
